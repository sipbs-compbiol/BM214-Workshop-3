...
::: { .callout-important }
There are three formative exercises, one for each exercise in the workshop, and they can be found on the workshop [MyPlace page](https://classes.myplace.strath.ac.uk/course/view.php?id=21632). You should complete these as part of the workshop.
:::
